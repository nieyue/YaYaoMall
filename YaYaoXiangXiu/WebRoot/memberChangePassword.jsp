  ...
  <div class="shop_hd_menu">
	...
	<div class="shop_hd_breadcrumb">
		...
		<span>
			...
			<a href="memberChangePassword.html">密码修改</a>
		</span>
	</div>
	<div class="clear"></div>
		...
		<div class="shop_member_bd_right clearfix">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<div class="shop_home_form">
					<form action="changeMem.dhtml"  class="shop_form" method="post">
						<ul>
							<li class="bn"><label>原密码：</label><input type="password" class="truename form-text inputid" name="loginPwd" placeholder="请输入原始密码"/>
							<s:fielderror fieldName="loginPwd" cssStyle="color:red;font-size:12px;"/>
							<s:fielderror fieldName="changeLoginPwd" cssStyle="color:red;font-size:12px;"/>
							</li>
							<li class="bn"><label>新密码：</label><input type="password" class="truename form-text inputid" name="newLoginPwd" placeholder="请输入新密码"/>
							<s:fielderror fieldName="newLoginPwd" cssStyle="color:red;font-size:12px;"/>
							</li>
							<li class="bn"><label>重复新密码：</label><input type="password" class="truename form-text inputid" name="reNewLoginPwd" placeholder="请确认新密码"/>
							<s:fielderror fieldName="reNewLoginPwd" cssStyle="color:red;font-size:12px;"/>
							</li>
