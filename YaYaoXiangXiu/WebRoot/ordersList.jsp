...
//评价订单
$(function(){
	$("#orderList_tbody tr .pingjia").each(function(){
		$(this).click(function(){
			$("#popDiv").show();
			$("#popIframe").show();
			$("#bg").show();
		var ci=$(this).parent().parent().parent().parent().parent().parent().attr("id");
		$("#commentForm").attr("action","addComment.dhtml?commentIndex="+ci);
		//$(this).parent().html("已评价");
		//$(this).remove();
		});
	});
	//取消订单
	$("#orderList_tbody tr .quxiao").each(function(){
		$(this).click(function(){		
		if(confirm("确定取消吗？")){
			...
			$.post(
				"rejectOrders.dhtml",
				{
		 rejectOrdersIndex:$(this).parent().parent().parent().parent().parent().parent().attr("id"),
				},
				function(){
					location.href="ordersList.html";
				});
		}else{
			return false;
		}
	...
	//恢复订单
	$("#orderList_tbody tr .huifu").each(function(){
		$(this).click(function(){		
		if(confirm("确定恢复吗？")){
			...
			$.post(
				"recoverOrders.dhtml",
				{
		 recoverOrdersIndex:$(this).parent().parent().parent().parent().parent().parent().attr("id"),
				},
				function(){
					location.href="ordersList.html";
				});
	...
	//删除订单
	$("#orderList_tbody tr .shanchu").each(function(){
		$(this).click(function(){		
		if(confirm("确定永久删除订单吗？")){
			
			$.post(
				"amputateOrders.dhtml",
				{
		 delOrdersIndex:$(this).parent().parent().parent().parent().parent().parent().attr("id"),
				},
				function(){
					location.href="ordersList.html";
				});
...
<form id="commentForm" action="addComment.dhtml" method="post">
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<table>
					...
					<tbody id="orderList_tbody">
						...
						<s:iterator value="#session.orderMerList" >
						<tr id="<s:property value="id" />"><td colspan="5">
							<table class="good">
								<thead >
									<tr>
									  <th colspan="7">
										<span><strong>订单号码：</strong><s:property value="order.orderNumber" /></span>	</th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<td class="dingdan_pic"><img  id="pictureid<s:property value="id" />" src="<s:property value="merchandise.picture" />" /></td>
										<td class="dingdan_title">
										  <div style="text-align:center;">
										    <span style="color:red;"><s:property value="merchandise.merName" /></span><br/>
										  </div>
										  <div style="text-align:left;">
										    <span style="color:blue;">收货地址：
										       <s:property value="order.consignee.address" />
										    </span>
										  </div>
										</td>
										<td class="dingdan_danjia">￥<strong><s:property value="price" /></strong></td>
										<td class="dingdan_shuliang"><s:property value="number" /></td>
										<td class="dingdan_zongjia">￥<strong><s:property value="money" /></strong><br />(免运费)</td>
										<td class="digndan_caozuo">
										<s:if test="orderStatus==1">已经下单<br/><a class="quxiao" style="color:red;text-decoration:none;" href="javascript:;">取消订单</a></s:if>
										<s:elseif test="orderStatus==0">
										  <a class="huifu" style="color:green;text-decoration:none;" href="javascript:;">恢复订单</a><br/>
										       已取消订单<br/>
										  <a class="shanchu" style="color:red;text-decoration:none;" href="javascript:;">删除订单</a>
										</s:elseif>
										<s:elseif test="orderStatus==2">已经发货</s:elseif>
										<s:elseif test="orderStatus==3"><span style="color:green;">完成交易</span></s:elseif>
										</td>
									    <td class="digndan_caozuo"><a class="pingjia" href="javascript:;" style="text-decoration:none;">评价</a></td>
									</tr>
								</tbody>
							</table>
						</td></tr>
					...
					<s:set name="orderMerList" value="#session.orderMerList"></s:set>
	                <s:if test="#orderMerList==null or #orderMerList.size==0">
						<span style="color:blue;font-size:12px;margin-left:300px;">
						还没有添加订单，赶紧去shopping吧！
						</span>
						</s:if>
			</div>
		</div>
