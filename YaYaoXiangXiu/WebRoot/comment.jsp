...
$(function(){
	//删除评论
	$("#comment_tbody a").each(function(){
		$(this).click(function(){
					//alert("删除评论成功！"); 
		if(confirm("确定删除吗？")){
			
			$.post("delComment.dhtml",
				{
			delCommentIndex:$(this).parent().parent().parent().parent().parent().parent().attr("id")
				},
				function(){
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<table>
					...
					<tbody id="comment_tbody">
						<s:iterator value="#session.memMerCommentList">
							...
							<table class="good" style="height:50px">
								<tbody>
									<tr>
										...
										<td class="pingjia_shuliang"><s:property value="merchandise.merName" /> <br />
										<img  src="<s:property value='merchandise.picture'/>" style="width:62px;height:62px;"/> <br />
										</td>
						...
						<s:set name="memMerCommentList" value="#session.memMerCommentList"></s:set>
	                    <s:if test="#memMerCommentList==null or #memMerCommentList.size==0">
