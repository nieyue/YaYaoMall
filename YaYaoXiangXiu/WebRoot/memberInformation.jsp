  ...
  <div class="shop_hd_menu">
	...
	<div class="shop_hd_breadcrumb">
		...
		<span>
			...
			<a href="memberInformation.html">个人资料</a>
		</span>
	</div>
	<div class="clear"></div>
	...
	<div class="shop_member_bd clearfix">
		...
		<div class="shop_member_bd_left clearfix">
			<div class="shop_member_bd_left_pic">
				<a href="javascript:;" id="memberPicture">
				<img src="images/avatar.png" /></a>
				<!-- <div id="addMemPic" style="width:100px;height:12px;border:1px solid #999;border-radius:5px;background-color:#ccc;color:white;padding:3px;text-decoration:none;cursor: pointer;">点击添加用户图片</div>
			 -->
			</div>
			<div class="clear"></div>
			<dl>
		...
		<div class="shop_member_bd_right clearfix">
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<div class="shop_home_form">
					<form action="memInformation.dhtml"  class="shop_form" method="post">
						<ul>
							<li><label>用户名称：</label><s:property value="#session.Member.loginName"/></li>
							<li><label>电子邮件：</label><input type="text" class="truename form-text inputid" name="email" value="<s:property value="#session.Member.email"/>"/>
							<s:fielderror fieldName="email" cssStyle="color:red;font-size:12px;"/>
							</li>
							<li><label>真实姓名：</label>
							<s:if test="#session.Member.memberName!=null or #session.Member.memberName!=''">
							<input type="text" class="truename form-text inputid" name="memberName" value="<s:property value="#session.Member.memberName"/>"/>
							</s:if>
							<s:else>
							<input type="text" class="truename form-text" name="memberName"/>
							</s:else>
							<s:fielderror fieldName="memberName" cssStyle="color:red;font-size:12px;"/>
							</li>
							
							<li><label>性别:</label>
								<s:if test="#session.Member.sex!=null">
							<s:property value="#session.Member.sex"/><a ></a>
							</s:if>
							<s:else>
