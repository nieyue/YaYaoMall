...
<form id="msform" action="ExclusiveCustomAction.dhtml">
	<fieldset>
	<p style="color:#FFFFFF; font-size:24px;">恭喜您，专属定制提交成功，您可在用户中心的<a href="customOrdersList.html">定制订单管理中心</a>查看自己的订单状态！</p>
	</fieldset>
</form>
