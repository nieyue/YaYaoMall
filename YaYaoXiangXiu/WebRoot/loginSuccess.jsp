...
<body>
  ...
  <div class="shop_hd_menu">
	...
	<br/>
	<br/>
	<h2>登陆成功，欢迎您<s:property value="#session.Member.loginName"/></h2>
	<br/>
    <br/>
    <br/>
    <br/>
    ...
    <br/>
    <br/>
	<a href="memberInformation.html">进入个人账户中心</a>或者 <a href="index.html">进入首页购物</a>
	</div>
	<br/>
    <br/>
    <br/>
