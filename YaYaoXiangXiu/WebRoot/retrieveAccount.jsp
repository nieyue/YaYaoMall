...
<body>
  ...
  <div class="shop_hd_menu">
	...
	<br/>
	<br/>
	<h1 style="font-size:26px;color:#4b5cc4">★请输入您的账户账号和邮箱，以便找回您的账户</h1>
	...
	<div style="margin:30px auto;border: 1px solid #ccc;padding:20px;width:400px;border-radius:5px;box-shadow:0px 0px 10px #999;background-color:#cca4e3;">
				<form action="retrieveAccountLogin.dhtml" method="post">
					<div style="height:60px;">
						<s:fielderror fieldName="retrieveAccountLoginError" cssStyle="color:red;font-size:12px;"/>
					...
					<div style="height:60px;">
						<div style="display:inline-block;font-size:20px;color:#801dae;">邮&nbsp;&nbsp;&nbsp;箱</div>
						<div style="display:inline-block;"><input type="email" style="width:200px;height:30px;border-radius:5px;" name="email" class="text inputid" placeholder="请输入注册时填入的邮箱"/></div>
					</div>
					
					<div>
						<div>&nbsp;</div>
						<div><input type="submit" style="width:80px;height:30px;background-color:green;color:white;" value="找回账户" class="submit"/> </div>
					</div>
					<s:token></s:token>
				</form>
