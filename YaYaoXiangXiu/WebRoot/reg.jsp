...
<div  class="long8">
	<div class="main">
		<div class="login-form fr">
			<div class="form-hd">
				<h3>用户注册</h3>
						<s:fielderror fieldName="regerror" cssStyle="color:red;font-size:12px;"/>
			</div>
			<div class="form-bd">
				<form action="memReg.dhtml" method="post">
					<dl>
						<dt>用户名</dt>
						<dd><input type="text" name="loginName" class="text inputid" placeholder="注册名长度为4~16个字符"/>
						</dd>
						<s:fielderror fieldName="loginName" cssStyle="color:red;font-size:12px;"/>
					</dl>
					<dl>
						<dt>密码</dt>
						<dd><input type="password" name="loginPwd" class="text inputid" placeholder="密码长度为6~16个字符"/>
						</dd>
						<s:fielderror fieldName="loginPwd" cssStyle="color:red;font-size:12px;"/>
					</dl>
					<dl>
						<dt>确认密码</dt>
						<dd><input type="password" name="reLoginPwd" class="text inputid" placeholder="两次密码必须相同"/>
						</dd>
						<s:fielderror fieldName="reLoginPwd" cssStyle="color:red;font-size:12px;"/>
					</dl>
					<dl>
						<dt>邮箱</dt>
						<dd><input type="text" name="email" class="text inputid" placeholder="邮箱能帮您找回丢失的账户"/>
						</dd>
					...
					<dl>
						...
						<dd><input type="text" name="validate" class="text inputid" size="10" style="width:58px;">
						 <img id="yanzhengma" src="imageAction" alt="" align="absmiddle" style="position:relative;top:-2px;"/> 
						 <a  onclick="document.getElementById('yanzhengma').src='imageAction.dhtml?'+ Math.random()" style="color:#999;cursor: pointer;text-decoration: none;">看不清，换一张</a>
						 </dd>
		...
		<div class="login-form-left fl">
			<dl class="func clearfix">
				<dt><img src="images/left.jpg" alt="" width="400" height="250" />
				</dt>
			</dl>
			
			<div class="if">
				<h2>如果您是本站用户</h2>
				<p>我已经注册过账号，立即 <a href="login.html" class="register">登录</a></p>
			</div>
		</div>
	</div>
</div>
